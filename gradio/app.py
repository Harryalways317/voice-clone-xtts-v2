...
default_speaker_name = "Kareena Main"
...
# # Random sentence (assuming english_sentences.txt is there)
# def random_sentence():
#     with open(Path("english_sentences.txt")) as f:
...
with gr.Blocks() as app:
    ...
    with gr.Row():
        with gr.Column():
            text_input = gr.Textbox(lines=2, label="Speechify this Text",value="The Apple iPhone 15 Pro is an exceptional choice for both gaming enthusiasts and everyday users. It boasts the advanced A17 Bionic chip, which is a game-changer in terms of performance. The 6GB of RAM, coupled with its cutting-edge processor, ensures seamless multitasking and gaming without any lag. Its standout feature is the 6.7-inch Super Retina XDR display, offering an outstanding resolution of 2796 x 1290 pixels, bringing games and videos to life with stunning clarity and color accuracy.")
...
if __name__ == "__main__":
    app.launch(server_name="0.0.0.0",share=True)  # we added share = True to share the app running local network with gradio url